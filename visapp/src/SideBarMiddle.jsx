...
function SideBarMiddle(props) {
 ...
 function colorBox(val){ //"#edb4d4", "#bbe7ed","#edac6f"
  if(val == 0) return {backgroundColor: "#edb4d4"};
  if(val == 1) return {backgroundColor:  "#bbe7ed"};
  if(val == 2){return {backgroundColor: "#edac6f"}}
 }
  return ( 
